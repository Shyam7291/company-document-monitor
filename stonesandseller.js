...
// Paste your hosted image URL here (e.g. GitHub raw URL). Leave "" to show the gradient only.
const HERO_IMAGE = "";
  ...
  return <div className="app"><style>{CSS}</style>
    ...
    <main className="content">
      ...
      {loading ? <div className="skeleton"><i/><div><i/><i/></div><div><i/><i/></div></div> : <>
        <section className="hero"><div className={`hero-card ${HERO_IMAGE ? "has-img" : ""}`}>{HERO_IMAGE && <img className="hero-img" src={HERO_IMAGE} alt="" aria-hidden="true" loading="eager"/>}<span className="hero-shade"/><span className="hero-glow"/><div><small>{seller.yardName}</small><h1>Your yard at a glance</h1><p>Track orders, queue and loading in real time.</p></div><div className="hero-stat"><strong>{number(todaySummary?.totalOrders)}</strong><span>orders today</span></div></div></section>
...
.hero-card{position:relative;overflow:hidden;display:flex;align-items:center;justify-content:space-between;gap:14px;min-height:150px;padding:20px 18px;border-radius:24px;background:linear-gradient(135deg,#1c2140 0%,#252b52 60%,#1a2a4a 100%);color:#fff;border:1px solid rgba(140,160,255,.35);box-shadow:0 0 0 1px rgba(91,108,255,.25),0 0 28px rgba(91,108,255,.35),0 18px 40px rgba(27,35,64,.30)}
.hero-img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:75% 55%;z-index:0}
.hero-shade{position:absolute;inset:0;z-index:1;background:linear-gradient(90deg,rgba(24,28,62,.94) 0%,rgba(24,28,62,.86) 42%,rgba(24,28,62,.45) 70%,rgba(24,28,62,.35) 100%),linear-gradient(180deg,rgba(24,28,62,.15),rgba(24,28,62,.55))}
.hero-card.has-img .hero-shade{background:linear-gradient(90deg,rgba(22,26,58,.92) 0%,rgba(22,26,58,.78) 40%,rgba(22,26,58,.28) 68%,rgba(22,26,58,.15) 100%),linear-gradient(180deg,rgba(22,26,58,.10),rgba(22,26,58,.55))}
.hero-glow{position:absolute;inset:0;z-index:2;pointer-events:none;border-radius:inherit;background:radial-gradient(circle at 0% 100%,rgba(91,108,255,.45),transparent 45%),radial-gradient(circle at 100% 0%,rgba(34,193,238,.35),transparent 40%)}
.hero-card:before{content:"";position:absolute;left:0;right:0;top:0;height:2px;z-index:3;background:var(--grad);opacity:.9}
.hero-card:after{content:"";position:absolute;inset:0;z-index:2;border-radius:inherit;pointer-events:none;box-shadow:inset 0 0 0 1px rgba(255,255,255,.08),inset 0 1px 0 rgba(255,255,255,.18)}
.hero-card>div{position:relative;z-index:4}
.hero-card small{display:block;font-size:10.5px;letter-spacing:.8px;text-transform:uppercase;font-weight:800;background:var(--grad);-webkit-background-clip:text;background-clip:text;color:transparent;filter:brightness(1.35)}
.hero-card h1{margin:5px 0 4px;font-size:19px;font-weight:800;letter-spacing:-.5px;line-height:1.15;text-shadow:0 2px 12px rgba(0,0,0,.35)}
.hero-card p{margin:0;font-size:12px;color:rgba(255,255,255,.82);text-shadow:0 1px 8px rgba(0,0,0,.35)}
.hero-stat{flex:none;text-align:center;padding:12px 14px;border-radius:18px;background:rgba(255,255,255,.10);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.28);box-shadow:0 8px 24px rgba(0,0,0,.25),0 0 0 1px rgba(91,108,255,.25)}
.hero-stat strong{display:block;font-size:28px;font-weight:900;letter-spacing:-1px;line-height:1;background:linear-gradient(135deg,#fff,#c9d4ff);-webkit-background-clip:text;background-clip:text;color:transparent}
.hero-stat span{font-size:10px;color:rgba(255,255,255,.85);font-weight:700}
...
.loading-card footer span{display:flex;align-items:center;gap:5px;font-size:9.5px;font-weight:700;color:#3b4468}
