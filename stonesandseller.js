...
.nav-pill button.active span{width:44px;height:44px;margin-top:-22px;border-radius:16px;background:var(--grad);color:#fff;border:3px solid #f4f7fd;box-shadow:0 12px 24px rgba(91,108,255,.45)}
