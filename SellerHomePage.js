...
.stage-glow{position:absolute;left:50%;top:52%;width:330px;height:330px;pointer-events:none;
  transform:translate(-50%,-50%);
  background:radial-gradient(circle,rgba(249,115,22,.16),rgba(37,99,235,.12) 42%,transparent 70%);
  filter:blur(26px);animation:stageGlow 8s ease-in-out infinite}
...
.stage-ring.ring-b{width:290px;height:290px;border-color:rgba(37,99,235,.2);
...
.orbit-card{position:absolute;left:50%;top:50%;width:158px;height:206px;
  ...
  padding:18px 14px;border-radius:24px;border:1px solid rgba(255,255,255,.9);
  background:linear-gradient(158deg,var(--tone-hi),#ffffff 46%,var(--tone-lo));
  box-shadow:0 18px 40px rgba(15,23,42,.14),inset 0 1px 0 rgba(255,255,255,.95);
...
.orbit-card.green{--tone:#16a36a;--tone-hi:rgba(22,163,106,.14);--tone-lo:rgba(22,163,106,.07);
  --tone-soft:rgba(22,163,106,.14)}
.orbit-card.blue{--tone:#2563eb;--tone-hi:rgba(37,99,235,.14);--tone-lo:rgba(37,99,235,.07);
  --tone-soft:rgba(37,99,235,.14)}
.orbit-card.orange{--tone:#f97316;--tone-hi:rgba(249,115,22,.15);--tone-lo:rgba(249,115,22,.07);
  --tone-soft:rgba(249,115,22,.15)}
.orbit-card.purple{--tone:#7c3aed;--tone-hi:rgba(124,58,237,.14);--tone-lo:rgba(124,58,237,.07);
  --tone-soft:rgba(124,58,237,.14)}
.orbit-card.is-active{cursor:default;filter:none;
  box-shadow:0 30px 62px rgba(15,23,42,.2),0 0 0 1px var(--tone-soft),
    0 12px 34px var(--tone-soft),inset 0 1px 0 rgba(255,255,255,.98);
...
.orbit-edge{position:absolute;inset:0;border-radius:inherit;padding:1.2px;pointer-events:none;
  ...
  -webkit-mask-composite:xor;mask-composite:exclude;opacity:.4;transition:opacity .45s}
.orbit-card.is-active .orbit-edge{opacity:.85}
...
.orbit-icon{position:relative;width:52px;height:52px;display:grid;place-items:center;
  ...
  box-shadow:0 10px 22px var(--tone-soft),inset 0 1px 0 rgba(255,255,255,.9)}
.orbit-icon-ring{position:absolute;inset:-6px;border:1.5px dashed var(--tone);border-radius:22px;
  opacity:.3;animation:ringSpin 11s linear infinite}
.orbit-title{max-width:100%;color:var(--ink);font-size:14px;font-weight:850;
...
.orbit-reflection{position:absolute;left:8%;right:8%;bottom:-16px;height:18px;border-radius:50%;
  ...
  filter:blur(7px);opacity:0;transition:opacity .45s}
...
.pager-dot{width:7px;height:7px;padding:0;border:0;border-radius:999px;cursor:pointer;
  background:#cfd8e6;transition:width .35s cubic-bezier(.22,1,.36,1),background .35s}
.pager-dot.on{width:22px}
.pager-dot.on.green{background:var(--green)}
.pager-dot.on.blue{background:var(--blue)}
.pager-dot.on.orange{background:var(--orange)}
.pager-dot.on.purple{background:var(--purple)}
...
@keyframes stageRing{0%,100%{opacity:.3;transform:translateX(-50%) rotateX(72deg) scale(.94)}
  50%{opacity:.7;transform:translateX(-50%) rotateX(72deg) scale(1.05)}}
